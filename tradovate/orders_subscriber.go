...
// 				symbol := ToTradovateFullSymbol(string(orderData.Symbol))
...
// 				lg.Sugar().Infof("Get tradovate order from websocket with orderID: %v clientOrderID: %v status: %v symbol: %v",
// 					orderID,
