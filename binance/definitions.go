...
// TODO: legal range is '^([0-9]{1,20})(\.[0-9]{1,20})?$' -- ?
var binancePriceFloorRE = regexp.MustCompile(`^[0-9]{1,20}(\.[0-9]{1,6})?`)

// TODO: legal range is '^([0-9]{1,20})(\.[0-9]{1,20})?$' -- ?
var binanceQtyFloorRE = regexp.MustCompile(`^[0-9]{1,20}(\.[0-9]{1,5})?`)
